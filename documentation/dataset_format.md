...
[road segmentation](../BraTSUMamba/dataset_conversion/Dataset120_RoadSegmentation.py) dataset as an example). 
...
See [here](../BraTSUMamba/imageio/readme.md).
...
When adding your custom dataset, take a look at the [dataset_conversion](../BraTSUMamba/dataset_conversion) folder and 
...
[here](../BraTSUMamba/dataset_conversion/generate_dataset_json.py). 
See our examples in [dataset_conversion](../BraTSUMamba/dataset_conversion) for how to use it. And read its documentation!
...
[script](../BraTSUMamba/dataset_conversion/Dataset120_RoadSegmentation.py).
...
In the `dataset_conversion` folder (see [here](../BraTSUMamba/dataset_conversion)) are multiple example scripts for 
