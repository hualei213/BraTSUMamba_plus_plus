...
def split_dataset():
    # 1. 定义路径
    source_data_dir = '//mnt/SSD2/YHR/dataset/BraTS2020/MICCAI_BraTS2020_TrainingData'
    txt_dir = '/mnt/SSD2/YHR/dataset/BraTS2020/KFold/0'

    # 定义你要存放的新文件夹路径 (你可以按需修改)
    target_base_dir = '/mnt/SSD2/YHR/dataset/BraTS2020/BraTS2020_Fold_0'
