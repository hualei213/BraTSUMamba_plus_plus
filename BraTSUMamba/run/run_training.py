...
from BraTSUMamba.run.load_pretrained_weights import load_pretrained_weights
...
def get_trainer_from_args(dataset_name_or_id: Union[int, str],
    ...
    nnunet_trainer = recursive_find_python_class(join(BraTSUMamba.__path__[0], "training", "nnUNetTrainer"),
    ...
    if nnunet_trainer is None:
        raise RuntimeError(f'Could not find requested nnunet trainer {trainer_name} in '
                           f'BraTSUMamba.training.nnUNetTrainer ('
                           f'{join(BraTSUMamba.__path__[0], "training", "nnUNetTrainer")}). If it is located somewhere '
...
def run_training_entry():
    ...
    parser.add_argument('dataset_name_or_id', type=str,default="1103",
