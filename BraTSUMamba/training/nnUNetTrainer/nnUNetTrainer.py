...
from BraTSUMamba.configuration import ANISO_THRESHOLD, default_num_processes
from BraTSUMamba.evaluation.evaluate_predictions import compute_metrics_on_folder
from BraTSUMamba.inference.export_prediction import export_prediction_from_logits, resample_and_save
...
from BraTSUMamba.paths import nnUNet_preprocessed, nnUNet_results
from BraTSUMamba.training.data_augmentation.compute_initial_patch_size import get_patch_size
from BraTSUMamba.training.dataloading.nnunet_dataset import infer_dataset_class
from BraTSUMamba.training.dataloading.data_loader import nnUNetDataLoader
from BraTSUMamba.training.logging.nnunet_logger import nnUNetLogger
from BraTSUMamba.training.loss.compound_losses import DC_and_CE_loss, DC_and_BCE_loss
from BraTSUMamba.training.loss.deep_supervision import DeepSupervisionWrapper
from BraTSUMamba.training.loss.dice import get_tp_fp_fn_tn, MemoryEfficientSoftDiceLoss
from BraTSUMamba.training.lr_scheduler.polylr import PolyLRScheduler
from BraTSUMamba.utilities.collate_outputs import collate_outputs
from BraTSUMamba.utilities.crossval_split import generate_crossval_split
from BraTSUMamba.utilities.default_n_proc_DA import get_allowed_n_proc_DA
from BraTSUMamba.utilities.file_path_utilities import check_workers_alive_and_busy
from BraTSUMamba.utilities.get_network_from_plans import get_network_from_plans
from BraTSUMamba.utilities.helpers import empty_cache, dummy_context
from BraTSUMamba.utilities.label_handling.label_handling import convert_labelmap_to_one_hot, determine_num_input_channels
from BraTSUMamba.utilities.plans_handling.plans_handler import PlansManager
...
class nnUNetTrainer(object):
    ...
    def on_epoch_end(self):
        ...
        if (current_epoch + 1) % self.save_every == 0 and current_epoch != 0:
            self.save_checkpoint(join(self.output_folder, f'checkpoint_epoch_{current_epoch+1}.pth'))
