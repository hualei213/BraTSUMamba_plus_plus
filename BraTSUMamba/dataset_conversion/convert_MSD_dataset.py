...
from BraTSUMamba.utilities.dataset_name_id_conversion import find_candidate_datasets
...
if __name__ == '__main__':
    convert_msd_dataset('/mnt/HDLV1/YHR/nnUNet-BraTSUMamba/nnUNet_raw/Task0001_MSD', overwrite_target_id=1111)
