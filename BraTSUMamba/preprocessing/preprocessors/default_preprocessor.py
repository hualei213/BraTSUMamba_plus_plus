...
import BraTSUMamba
from BraTSUMamba.paths import nnUNet_preprocessed, nnUNet_raw
from BraTSUMamba.preprocessing.cropping.cropping import crop_to_nonzero
from BraTSUMamba.preprocessing.resampling.default_resampling import compute_new_shape
from BraTSUMamba.training.dataloading.nnunet_dataset import nnUNetDatasetBlosc2
...
class DefaultPreprocessor(object):
    ...
    def _normalize(self, data: np.ndarray, seg: np.ndarray, configuration_manager: ConfigurationManager,
        ...
        for c in range(data.shape[0]):
            ...
            normalizer_class = recursive_find_python_class(join(BraTSUMamba.__path__[0], "preprocessing", "normalization"),
                                                           scheme,
                                                           'BraTSUMamba.preprocessing.normalization')
