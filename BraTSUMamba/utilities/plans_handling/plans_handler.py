...
from BraTSUMamba.preprocessing.resampling.utils import recursive_find_resampling_fn_by_name
import BraTSUMamba
from batchgenerators.utilities.file_and_folder_operations import load_json, join

from BraTSUMamba.imageio.reader_writer_registry import recursive_find_reader_writer_by_name
from BraTSUMamba.utilities.find_class_by_name import recursive_find_python_class
from BraTSUMamba.utilities.label_handling.label_handling import get_labelmanager_class_from_plans
...
if TYPE_CHECKING:
    from BraTSUMamba.utilities.label_handling.label_handling import LabelManager
    from BraTSUMamba.imageio.base_reader_writer import BaseReaderWriter
    from BraTSUMamba.preprocessing.preprocessors.default_preprocessor import DefaultPreprocessor
    from BraTSUMamba.experiment_planning.experiment_planners.default_experiment_planner import ExperimentPlanner
...
class ConfigurationManager(object):
    ...
    def preprocessor_class(self) -> Type[DefaultPreprocessor]:
        preprocessor_class = recursive_find_python_class(join(BraTSUMamba.__path__[0], "preprocessing"),
                                                         self.preprocessor_name,
                                                         current_module="BraTSUMamba.preprocessing")
...
class PlansManager(object):
    ...
    def experiment_planner_class(self) -> Type[ExperimentPlanner]:
        ...
        experiment_planner = recursive_find_python_class(join(BraTSUMamba.__path__[0], "experiment_planning"),
                                                         planner_name,
                                                         current_module="BraTSUMamba.experiment_planning")
...
if __name__ == '__main__':
    from BraTSUMamba.paths import nnUNet_preprocessed
    from BraTSUMamba.utilities.dataset_name_id_conversion import maybe_convert_to_dataset_name
